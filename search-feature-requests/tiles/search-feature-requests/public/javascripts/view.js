    ...
    jive.tile.getContainer(function(container) {
        ...
        function showResults() {
            ...
            for (var r of results) {
				...
				// icon lines are a workaround becuase the "jive-icon med jive-icon-idea" class is required to display the idea icon in Jive, but passing that value in from the API will produce this error in Chrome: "contains HTML space characters, which are not valid in tokens"
